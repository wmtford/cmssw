void RelVal(
// 	    char* newFile="../val.RelValQCD_Pt_3000_3500_9k.root",
//             char* refFile="../val.RelValQCD_Pt_3000_3500_prod.root")
//             char* newFile="../val.RelVal_3T_420_noSplit_1k.root",
//             char* refFile="../val.RelVal_3T_420_digibug_noSplit_1k.root"
//             char* newFile="../val.RelVal_3T_420_splSST_1k.root",
//             char* newFile="../val.RelVal_3T_420_splSST_step45_1k.root",
//             char* refFile="../val.RelVal_3T_420_noSplit_step45_1k.root"
//             char* newFile="../val.RelVal_3T_420_splPix_1k.root",
//             char* refFile="../val.RelVal_3T_420_noSplit_1k.root"
//             char* newFile="../mtv_split_no_25tev.root",
//             char* refFile="../val.RelVal_3T_420_noSplit_1k.root"
//             char* newFile="../mtv_split_sim_25tev.root",
//             char* refFile="../mtv_split_no_25tev.root"
//             char* newFile="../mtv_split_no_25tev.root",
//             char* refFile="../val.RelValQCD_Pt_3000_3500_415prod.root"
//             char* newFile="../mtv_split_sim_25tev.root",
//             char* refFile="/usr/users/wtford/cms/rel416/src/mtv_split_sim_25tev.root"
//             char* newFile="../mtv_split_no_25tev.root",
//             char* refFile="/usr/users/wtford/cms/rel416/src/mtv_split_no_25tev.root"
//             char* newFile="../mtv_split_no_25tev.root",
//             char* refFile="/usr/users/wtford/cms/rel420/src/wtfRecoLocalTracker/SplitClustersProducer/test/val.RelValQCD_Pt_3000_3500_prod.root"
//             char* newFile="../mtv_split_sim_recopath_1k.root",
//             char* refFile="../mtv_split_sim_1k.root"
//             char* newFile="../mtv_split_sim_1k.root",
//             char* refFile="../mtv_split_no_1k.root"
//             char* newFile="../mtv_split_SST_sim_1k.root",
//             char* refFile="../mtv_split_sim_1k.root"
//             char* newFile="../mtv_split_noSST_sim_1k.root",
//             char* refFile="../mtv_split_sim_1k.root"
//             char* newFile="../val.RelVal_3T_420_splPixSST_trim_1k.root",
//             char* refFile="../val.RelVal_3T_420_splSST_1k.root"
//             char* newFile="../val.RelVal_3T_420_splSST_trim_1k.root",
//             char* refFile="../val.RelVal_3T_420_splSST_1k.root"
//             char* newFile="../val.RelVal_3T_420_splPixSST_1k.root",
//             char* refFile="../val.RelVal_3T_420_noSplit_1k.root"
//             char* refFile="../val.RelVal_3T_420_splPix_1k.root"
//             char* newFile="../val.RelVal_spl_TT_440_noSplit.root",
//             char* refFile="../val.RelValTTbarSTART442_V11_noPU_highPurity_prod.root"
//             char* newFile="../val.RelVal_spl_TT_440_splitSST_1k.root",
//             char* refFile="../val.RelVal_spl_TT_440_noSplit.root"
//             char* newFile="../val.RelVal_spl_TT_440_splitPixSST_1k.root",
//             char* refFile="../val.RelVal_spl_TT_440_noSplit.root"
//             char* newFile="../val.RelVal_spl_TT_440_splitPixSST_allCol_1k.root",
//             char* refFile="../val.RelVal_spl_TT_440_splitPixSST_1k.root"
//             char* newFile="/usr/users/mulholland/MYWORK/cmsData/mtv_qcd3tev_111111.root",
//             char* refFile="/usr/users/wtford/cms/rel416/src/val.RelValQCD_Pt_3000_3500_415prod.root"
//             char* newFile="../val.RelVal_spl_3T_440p9_splSST_829.root",
//             char* newFile="../val.RelVal_spl_3T_440p9_splSSTbrl_1k.root",
//             char* refFile="../val.RelValQCD_Pt_3000_3500_prod.root"
//             char* newFile="../val.RelVal_spl_3T_440p9_splSSTbrl_reco_1k.root",
//             char* refFile="../val.RelVal_spl_3T_440p9_splSSTbrl_1k.root"
//             char* newFile="../val.RelVal_spl_3T_440p9_splSSTtibtob_1k.root",
//             char* refFile="../val.RelValQCD_Pt_3000_3500_prod.root"
//             char* newFile="../val.RelVal_spl_3T_440p9_splSSTtibtob_p1_1k.root",
//             char* refFile="../val.RelValQCD_Pt_3000_3500_prod.root"
//             char* newFile="../cmsData/mtv_3T_440p9_splSSTtibtob_gavrilcfg1_1k.root",
//             char* refFile="../val.RelValQCD_Pt_3000_3500_prod.root"
//             char* newFile="../val.RelVal_spl_3T_440p9_splSSTtibtob_p1_1k.root",
//             char* refFile="../val.RelVal_spl_3T_440p9_splSSTtibtob_1k.root"
//             char* newFile="../val.RelVal_spl_3T_440p9_splSSTtibtob_noDEdxcut_1k.root",
//             char* refFile="../val.RelValQCD_Pt_3000_3500_prod.root"
//             char* newFile="../val.RelVal_spl_3T_440p9_splSST_nosplit_1k.root",
            char* newFile="../val.RelVal_spl_3T_440p9_splSST_allRefs_1k.root",
            char* refFile="../val.RelVal_spl_3T_440p9_splSSTtibtob_noDEdxcut_1k.root"
	    )
{
...
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9_noPU_hiPur_9k");
//  char* refLabel("RelValQCD_Pt_3000_3500, CMSSW_4_2_0 MC_42_V9_noPU_hiPur_prod");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 noSplit");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 digibug_noSplit");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 splSST_2Tk");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 step45_splSST_2Tk");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 step45_noSplit");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_1_6 MC_311_V2 splPix_no");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 noSplit");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_1_6 MC_311_V2 splPix_sim");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_1_6 MC_311_V2 splPix_no");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_1_6 MC_311_V2 splPix_no");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_1_5 MC_311_V2 production");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 splPix_sim");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_1_6 MC_311_V2 splPix_sim");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 splPix_no");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_1_6 MC_311_V2 splPix_no");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 noSplit Hella/Gavril");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 noSplit prod");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 Split Pix Hella/Gavril");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 Split Pix straight trk");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 Split Pix Hella/Gavril");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 no Split Pix");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 Split Pix Hella/Gavril + Strips");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 Split Pix Hella/Gavril");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 Split Pix Hella/Gavril + noStrips");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 Split Pix Hella/Gavril");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 splPixSST_2Tk excl low chg clusters");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 splSST_2Tk");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 splSST_2Tk excl low chg clusters");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 splSST_2Tk");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 split pixels and strips");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 no split");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 split pixels and strips");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_2_0 MC_42_V9 split pixels");
//  char* newLabel("TTbar, 4_4_0_pre4 START_42_V11 no split");
//  char* refLabel("TTbar, 4_2_2 START_42_V11_noPU_hiPurity RelVal production");
//  char* newLabel("TTbar, 4_4_0_pre4 START_42_V11 split strips");
//  char* refLabel("TTbar, 4_4_0_pre4 START_42_V11 no split");
//  char* newLabel("TTbar, 4_4_0_pre4 START_42_V11 split pixels and strips");
//  char* refLabel("TTbar, 4_4_0_pre4 START_42_V11 no split");
//  char* newLabel("TTbar, 4_4_0_pre4 START_42_V11 split pixels and strips, keep all");
//  char* refLabel("TTbar, 4_4_0_pre4 START_42_V11 split pixels and strips");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_1_6 MC_311_V2 splSST_sim");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_1_6 MC_311_V2 prod");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 prod");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim TIB,TOB");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim TIB,TOB");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 full reco");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim TIB,TOB");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_1_6 MC_311_V2 prod");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim hitsOnFly");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim TIB,TOB noDEdxcut");
//  char* newLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim no split");
//  char* refLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 prod");
 char* newLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim TIB,TOB allRefs");
 char* refLabel("RelValQCD_Pt_3000_3500, 4_4_0_pre9 START44_V4 splSST_sim TIB,TOB noDEdxcut");
...
//   sh1->GetYaxis()->SetRangeUser(0.5,1.025);
   ...
   rh2->GetYaxis()->SetRangeUser(0.,0.7);
   sh2->GetYaxis()->SetRangeUser(0.,0.7);
...
//    sh3->GetXaxis()->SetRangeUser(0,300);
   rh3->GetXaxis()->SetRangeUser(0.5,1000);  // def. 0.5
   sh3->GetXaxis()->SetRangeUser(0.5,1000);  //  "
   if (iter4) {
     rh3->GetYaxis()->SetRangeUser(0.,.12);
     sh3->GetYaxis()->SetRangeUser(0.,.12);
   } else {
...
//    sh4->GetXaxis()->SetRangeUser(0.2,300);
   rh4->GetXaxis()->SetRangeUser(0.5,1000);
   sh4->GetXaxis()->SetRangeUser(0.5,1000);
   // < wtf
   ...
   // wtf >>
//    NormalizeHistograms(rh2,sh2);
//    rh2->SetNormFactor(1.);  // (doesn't work)
  // << wtf
   plot4histos(canvas,
	       sh1,rh1,sh2,rh2,
	       sh3,rh3,sh4,rh4,
   ...
   */
   ...
   // wtf >>
   if (iter4) {
     rh1->GetYaxis()->SetRangeUser(0.,0.12);
     sh1->GetYaxis()->SetRangeUser(0.,0.12);
   }
   // << wtf
   ...
   // wtf >>
   if (iter4) {
     rh3->GetYaxis()->SetRangeUser(0.,0.12);
     sh3->GetYaxis()->SetRangeUser(0.,0.12);
   }
   // << wtf
   rh3->GetYaxis()->SetTitleSize(0.05);
   rh3->GetYaxis()->SetTitleOffset(1.2);
   ...
   rh4->GetYaxis()->SetTitleSize(0.05);
   rh4->GetYaxis()->SetTitleOffset(1.2);
   rh4->GetYaxis()->SetRangeUser(0.,0.7);
   sh4->GetYaxis()->SetRangeUser(0.,0.7);
   ...
   rh5->GetYaxis()->SetTitleSize(0.05);
   rh5->GetYaxis()->SetTitleOffset(1.2);
   rh5->GetYaxis()->SetRangeUser(0.5,1.025);
   sh5->GetYaxis()->SetRangeUser(0.5,1.025);
   ...
   rh2->GetYaxis()->SetRangeUser(0.5,1.025);
   sh2->GetYaxis()->SetRangeUser(0.5,1.025);
   rh2->GetYaxis()->SetTitleSize(0.05);
   rh2->GetYaxis()->SetTitleOffset(1.2);
   rh2->SetTitle("");
