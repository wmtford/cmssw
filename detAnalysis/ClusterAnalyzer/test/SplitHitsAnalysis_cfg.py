...
# debugModules = 
#cms.untracked.vstring('SiStripQualityHotStripIdentifierRoot','siStripQualityHotStripIdentifierRoot','SiStripHotStripAlgorithmFromClusterOccupancy'),
# log = cms.untracked.PSet( threshold = cms.untracked.string('INFO') ),
# destinations = cms.untracked.vstring('log5.txt')
#)
...
process.siStripMatchedRecHits = cms.EDProducer("SiStripRecHitConverter",
 ...
 ClusterProducer = cms.string('siStripSplitClusters'),
